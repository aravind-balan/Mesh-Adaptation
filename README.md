...
for parallel processing. $NP is the number of processes(threads) you wish to run. They should ideally not exceed the total number of processors and should be a multiple of 2.